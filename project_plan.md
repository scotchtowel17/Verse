...
| # | Probe area | Status |
|---|---|---|
| AC1 | Note resize by dragging its right edge | DONE (screen: edge drag lengthens, snaps, start held)|
| AC2 | Velocity drag mode (V toggle) | DONE (headless: velocity clamp 1-127, one undo) |
| AC3 | Loop region create / move / resize (option-drag ruler) | DONE (screen: loop set from clip, band drawn)|
| AC4 | Loop playback wrap-around | DONE (screen: playhead wraps at the loop end)|
| AC5 | Clip drag between tracks in the arrangement | DONE (screen: clip changed track, colour + notes kept)|
| AC6 | Clip resize in the arrangement | DONE (screen: clip resize; trim non-destructive)|
| AC7 | Clip split at playhead (scissors) | DONE (screen: split at playhead, 2 clips, notes kept)|
| AC8 | Clip duplicate | DONE (screen: duplicate)|
| AC9 | Track menu: rename / delete | DONE (screen: track menu complete)|
...
| AC16 | Instrument change (sound picker) | DONE (screen: instrument menu, status follows)|
